...
# Test case for successfully removing a pin from a message
def test_message_unpin_v1_successful(reset_datastore, three_new_sample_users):
	...
	response1 = requests.post(f"{url}message/unpin/v1",
                                    json={'token': three_new_sample_users['sample_token_0'],
                                            'message_id': message_id['message_id']})
	...
	assert response2['messages'][0]['is_pinned'] == False                               
	...
	response3 = requests.post(f"{url}message/unpin/v1",
									json={'token': three_new_sample_users['sample_token_0'],
											'message_id': message_id2['message_id']})
	...
	assert response4['messages'][0]['is_pinned'] == False
	assert response3.status_code == 200
# Test case when message_id refers to an invalid message
def test_message_unpin_v1_invalid_message(reset_datastore, three_new_sample_users):
    new_channel = requests.post(f"{url}channels/create/v2", 
                                json={'token': three_new_sample_users['sample_token_0'], 
                                        'name': 'newChannel', 
                                        'is_public': True}).json()
    ...
    response2 = requests.post(f"{url}message/unpin/v1",
                                    json={'token': three_new_sample_users['sample_token_0'],
                                            'message_id': 456})
...
def test_message_unpin_v1_already_unpinned(reset_datastore, three_new_sample_users):
    new_channel = requests.post(f"{url}channels/create/v2", 
                                json={'token': three_new_sample_users['sample_token_0'], 
                                        'name': 'newChannel', 
                                        'is_public': True}).json()
    ...
    requests.post(f"{url}message/unpin/v1",
                                    json={'token': three_new_sample_users['sample_token_0'],
                                            'message_id': message_id['message_id']})
...
def test_message_unpin_v1_auth_not_owner(reset_datastore, three_new_sample_users):
    new_channel = requests.post(f"{url}channels/create/v2", 
                                json={'token': three_new_sample_users['sample_token_0'], 
                                        'name': 'newChannel', 
                                        'is_public': True}).json()
...
def test_message_unpin_v1_auth_id_not_member(reset_datastore, three_new_sample_users):
	...
	message_unpin = requests.post(f"{url}message/unpin/v1",
                            json={'token': three_new_sample_users['sample_token_1'],
                                    'message_id': message['message_id']})
